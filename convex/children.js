...
exports.deactivate = exports.get = exports.listAll = exports.list = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, children.sort(function (a, b) { return a.lastName.localeCompare(b.lastName); })];
            }
        });
    }); },
});
...
exports.listAll = (0, server_1.query)({
    ...
    handler: function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ctx.db.query("children").collect()];
                case 1:
                    children = _a.sent();
                    return [2 /*return*/, children.sort(function (a, b) { return a.lastName.localeCompare(b.lastName); })];
            }
...
exports.get = (0, server_1.query)({
    args: { id: values_1.v.id("children") },
