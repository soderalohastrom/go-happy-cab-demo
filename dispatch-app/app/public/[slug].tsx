...
export default function PublicDispatchPage() {
  ...
  return (
    <View style={styles.container} dataSet={{ print: "root" }}>
      ...
      {Platform.OS === 'web' && (
        <style type="text/css">{`
          @media print {
            ...
            /* Main container reset - Fix truncation */
            html, body {
              height: 100% !important;
              overflow: visible !important;
            }
            
            /* Target the ScrollView's wrapper div generated by RN Web */
            ...
            /* Ensure the outer view also expands */
